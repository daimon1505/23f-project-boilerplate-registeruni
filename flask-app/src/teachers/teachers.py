...
@Course.route('/Teacher', methods=['GET'])
def get_teachers():
...
# Add a new teacher
@Course.route('/teachers', methods=['POST'])
def add_teacher():
...
@Course.route('/teachers/<int:teacher_id>/courses', methods=['GET'])
...
@Course.route('/teachers/<int:teacher_id>', methods=['DELETE'])
...
@Course.route('/departments/<int:department_key>/teachers', methods=['GET'])
...
@Course.route('/teachers/<int:teacher_id>', methods=['PUT'])
