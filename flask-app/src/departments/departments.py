...
@Department.route('/Department/<int:DepartmentKey>', methods=['GET'])
...
@Department.route('/departments/<int:department_key>', methods=['PUT'])
...
@Department.route('/departments/<int:department_key>', methods=['DELETE'])
...
@Department.route('/departments/courses/count', methods=['GET'])
