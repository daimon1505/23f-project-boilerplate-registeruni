...
registar = Blueprint('registrar', __name__)

@registar.route('/registrar', methods=['GET'])
def get_registrars():
...
@registar.route('/registrar', methods=['POST'])
def add_registrar():
    data = request.json
    cursor = db.get_db().cursor()
    cursor.execute(
...
@registar.route('/registrar/<int:registrar_id>', methods=['PUT'])
...
@registar.route('/registrar/<int:registrar_id>', methods=['GET'])
...
@registar.route('/registrar/<int:registrar_id>', methods=['DELETE'])
...
@registar.route('/registrar/<int:registrar_id>/courses', methods=['GET'])
...
@registar.route('/registrar/<int:registrar_id>/courses', methods=['PUT'])
